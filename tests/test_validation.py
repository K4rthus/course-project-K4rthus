from app.core.security import sanitize_text, validate_and_save_file
...
def test_file_size_validation(tmp_path):
    ...
    success, reason = validate_and_save_file(str(tmp_path), "test.png", large_file)
...
def test_magic_bytes_validation(tmp_path):
    ...
    success, reason = validate_and_save_file(str(tmp_path), "test.png", fake_png)
